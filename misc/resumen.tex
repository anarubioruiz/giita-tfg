...
El presente documento es un ejemplo de memoria del Trabajo de Fin Grado según el formato y criterios del Grado en Ingeniería Informática de la Facultad de Ciencias Sociales y Tecnologías de la Información de Talavera de la Reina. La intención es que este texto sirva además como una serie de consejos sobre tipografía, \LaTeX, redacción y estructura de la memoria que podrían resultar de ayuda. Por este motivo, se aconseja consultar también el código fuente de este documento, que usa la clase \LaTeX{} \giitatfg{}:

 \url{https://github.com/anarubioruiz/giita-tfg}

Si encuentras cualquier error o tienes alguna sugerencia, por favor, utiliza el \emph{issue tracker} del proyecto \giitatfg{} en:

\url{https://github.com/anarubioruiz/giita-tfg/issues}
